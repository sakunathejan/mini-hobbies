  ...
  return (
    <>
      ...
      <section className="grid min-h-screen place-items-center bg-graphite px-4">
        <form onSubmit={submit} className="w-full max-w-md rounded-lg bg-white p-6 shadow-soft" noValidate>
          ...
          <button
            disabled={loading}
            className="btn-primary mt-5 w-full min-h-[48px] disabled:bg-gray-300"
            type="submit"
          >
